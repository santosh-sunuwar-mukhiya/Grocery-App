...
from practice.api.dependencies import SellerServiceDep, SessionDep, get_access_token
...
@router.get("/logout")
async def logout_seller(token_data: Annotated[dict, Depends(get_access_token)]) -> dict:
